(function (L, P) {
     ...
     */ const P = (() => {
        ...
        xi = () => {
            ...
            return i && !document.body.hasAttribute("data-twe-no-jquery")
                ? i
                : null;
        },
        xe = [],
    ...
    function Kt(i) {
        for (
            var t = U(i), e = as(i);
            e && nr(e) && it(e).position === "static";

        )
            e = as(e);
        return e &&
            (Q(e) === "html" ||
                (Q(e) === "body" && it(e).position === "static"))
            ? t
            : e || rr(i) || t;
    }
    function Ke(i) {
    ...
    function It(i, t) {
        ...
        var e = t,
            ...
            p = i.elements[O ? I : v],
            _ = br(
                ht(p) ? p : p.contextElement || rt(i.elements.popper),
                l,
                c,
                o
            ),
                            ...
                            if (ys(I, m)) {
                                (c.rects = {
                                    ...
                                    c.orderedModifiers.forEach(function (N) {
                                        return (c.modifiersData[N.name] =
                                            Object.assign({}, N.data));
                                    });
                                for (
                                    var p = 0;
                                    p < c.orderedModifiers.length;
                                    p++
                                ) {
                                    if (c.reset === !0) {
                                        (c.reset = !1), (p = -1);
    ...
    const jr = 3,
        h = {
            ...
            parents(i, t) {
                ...
                for (
                    ;
                    s && s.nodeType === Node.ELEMENT_NODE && s.nodeType !== jr;
    ...
    class z extends et {
        constructor(t, e) {
            ...
            (this._animationCanPlay =
                this._config.dropdownAnimation === "on" && !s),
                (this._didInit = !1),
                this._init();
        }
        static get Default() {
        ...
        _completeHide(t) {
            (this._fadeOutAnimate &&
                this._fadeOutAnimate.playState === "running") ||
                ...
                setTimeout(
                    () => {
                        this._popper && this._popper.destroy(),
                            this._menu.removeAttribute(
                                `data-twe-dropdown-${ot}`
                            ),
        ...
        _getPlacement() {
            ...
            return t.dataset.tweDropdownPosition === Qr
                ? e
                    ? no
                    : so
                : e
        ...
        _setElementAttributes(t, e, s) {
            const n = this.getWidth(),
                r = (o) => {
                    if (
                        o !== this._element &&
                        window.innerWidth > o.clientWidth + n
                    )
                        return;
    ...
    class Pt extends et {
        ...
        show(t) {
            if (
                this._isShown ||
                d.trigger(this._element, Io, { relatedTarget: t })
                    .defaultPrevented
            )
                return;
            (this._isShown = !0),
    ...
    class q extends et {
        ...
        pause(t) {
            t || (this._isPaused = !0),
                h.findOne(aa, this._element) &&
                    (Ri(this._element), this.cycle(!0)),
        ...
        _addEventListeners() {
            this._config.keyboard &&
                d.on(this._element, Fo, (t) => this._keydown(t)),
        ...
        _addTouchEventListeners() {
            const t = (r) =>
                    this._pointerEvent &&
                    (r.pointerType === ua || r.pointerType === da),
                e = (r) => {
                    t(r)
                        ? (this.touchStartX = r.clientX)
                        : this._pointerEvent ||
                          (this.touchStartX = r.touches[0].clientX);
                },
                s = (r) => {
                    this.touchDeltaX =
        ...
        _getItemIndex(t) {
            return (
                (this._items =
                    t && t.parentNode ? h.find(fi, t.parentNode) : []),
    ...
    class Et extends et {
        ...
        _enter(t, e) {
            if (
                ...
                e.getTipElement().classList.contains(pi) ||
                    e._hoverState === Gt)
            ) {
                e._hoverState = Gt;
                return;
        ...
        _getConfig(t) {
            ...
            return (
                ...
                (t.container =
                    t.container === !1 ? document.body : nt(t.container)),
                ...
                t.sanitize &&
                    (t.template = Zs(t.template, t.allowList, t.sanitizeFn)),
                t
            );
        }
        _getDelegateConfig() {
    ...
    class be extends et {
        ...
        show() {
            ...
            const r = t
                ? d.trigger(t, Fa, { relatedTarget: this._element })
                : null;
            if (
                d.trigger(this._element, qa, { relatedTarget: t })
                    .defaultPrevented ||
...
/*# sourceMappingURL=data:application/json;base64,`.concat(
            ...
            (() => {
                ...
                n()(r.Z, { insert: "head", singleton: !1 }),
                    ...
                    document.addEventListener(
                        "input",
                        function (l) {
                            l.inputType !== "insertReplacementText" &&
                            "data" in l
                                ? a(l.target)
                                : o(l.target);
                        },
    ...
    class S {
            ...
            d.on(this._element, "focus", "input", S.activate(new S())),
                ...
                d.on(window, "shown.twe.tab", (t) => {
                    ...
                    t.target.href
                        ...
                        : (e = E.getDataAttribute(t.target, "target").split(
                              "#"
                          )[1]);
                    const s = h.findOne(`#${e}`);
        ...
        _deactivate(t) {
            ...
            s.removeAttribute(mn),
                e.value === "" &&
                    (e.removeAttribute(at), s.removeAttribute(at)),
                this._toggleDefaultDatePlaceholder(e);
        }
        static activate(t) {
            return function (e) {
    ...
    const hl = { property: "color", defaultValue: null, inherit: !0 },
        Wt = (i, t) => {
            ...
            return (
                document.body.removeChild(r), !n && u && a === u ? s : a || s
            );
        },
        yi = "ripple",
        ye = "twe.ripple",
    ...
    class Oe {
        ...
        _autoInit(t) {
            pl.forEach((e) => {
                h.closest(t.target, e) &&
                    (this._element = h.closest(t.target, e));
            }),
            ...
            this._rippleTimer &&
                ...
                (this._rippleTimer = setTimeout(() => {
                    if (t && (t.remove(), this._element)) {
                        h
                            .find("[data-twe-ripple-ref]", this._element)
                            .forEach((n) => {
                                n.remove();
                            }),
                            this._isMinWidthSet &&
            ...
            (localStorage.theme === "dark" ||
                (!("theme" in localStorage) &&
                    window.matchMedia("(prefers-color-scheme: dark)")
                        .matches)) &&
                (e =
                    this._options.rippleColorDark || this._options.rippleColor);
        ...
        _colorToRGB(t) {
            ...
            function s(r) {
                ...
                return (
                    ...
                    o.style.color !== a ||
                    ((o.style.color = r),
                    o.style.color === a || o.style.color === "")
                        ? Ce
                        : ((r = getComputedStyle(o).color),
    ...
    class te extends et {
        ...
        show(t) {
            this._isShown ||
                this._isTransitioning ||
                d.trigger(this._element, Cl, { relatedTarget: t })
                    .defaultPrevented ||
                ((this._isShown = !0),
        ...
        hide() {
            ...
            e && (this._isTransitioning = !0),
                ...
                this._focustrap.disable(),
                h
                    .findOne(Jt, this._element)
                    .classList.remove(this._classes.show),
            ...
            dropdown: {
                ...
                callback: (i, t) => {
                    d.on(document, `click.twe.${i.NAME}`, t, function (e) {
                        e.preventDefault(),
                            i.getOrCreateInstance(this).toggle();
                    });
                },
            },
            ripple: {
